...
5. After the image hasloaded, pause execution for 2 seconds using the'wait'
...
7. After the second image hasloaded, pause execution for 2 seconds again
8. After the2 seconds have passed, hide the currentimage
